...
def run():
    ...
    subprocess.run(['git', 'init'])  # Inicializa un nuevo repositorio git en el directorio actual
    ...
    subprocess.run(['git', 'push', '-u', 'origin', 'master'])  # Empuja al repositorio remoto, ajusta 'master' si es necesario
